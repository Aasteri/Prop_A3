...
export const DEMO_USERS: DemoUserDef[] = [
  {
    ...
    firstName: 'Ahmed Abraham',
    lastName: 'Laucarie',
    role: UserRole.CEO,
    phone: '+2348000000001',
  },
  {
    email: 'admin@propa3.com',
    password: 'Admin@Propa3!',
    firstName: 'System',
    lastName: 'Admin',
    role: UserRole.ADMIN,
    phone: '+2348000000010',
  ...
  {
    email: 'architect@propa3.com',
    password: 'Architect@Propa3!',
    firstName: 'Design',
    lastName: 'Architect',
  ...
  {
    email: 'artisan.elec@propa3.com',
    password: 'ArtisanElec@Propa3!',
    firstName: 'Bola',
