...
export const PROJECT_STAGES: ProcessStageDef[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        href: '/plant-equipment-schedules',
        title: '4. Plant & equipment schedules',
        description: 'Hire/usage lines: source, times, qty, and cost unit.',
        icon: 'hardhat',
        status: 'live',
      },
      {
        href: '/planning-cycles',
        title: '5. Planning cycles',
      ...
      {
        href: '/qc-plans',
        title: '7. Quality control · Planning',
  ...
  },
  {
    ...
    links: [
      ...
      {
        href: '/project-cashbooks',
        title: '7. Project cashbooks',
        description: 'Site expenses and inflow record with running balance.',
        icon: 'wallet',
        status: 'live',
      },
      {
        href: '/inspections',
        title: '8. Quality control · Execution',
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        href: '/project-cashbooks',
        title: '7. Project cashbooks',
        description: 'Site cash inflows/outflows with running balance.',
        icon: 'wallet',
        status: 'live',
      },
      {
        href: '/project-analysis',
        title: '8. Project analysis',
