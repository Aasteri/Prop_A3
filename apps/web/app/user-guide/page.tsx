...
import { GLOSSARY, GUIDE_SECTIONS } from '@/lib/user-guide-content';
      ...
      <div className="space-y-8">
        <header className={PAGE_HEADER}>
          ...
          <p className="mt-2 max-w-3xl text-sm text-slate-200/90">
            How to run Projects, Properties (FM + Sales), Procurement, and Finance without guesswork.
            Terminology is defined in the glossary below.
          </p>
        </header>
        ...
        <p className="pb-8 text-center text-xs text-slate-500">
          Triple A Realty / Propa3 · Guide tracks live modules on main · Ask Admin if a WAITING
          document arrives from Abraham
        </p>
      </div>
    </AppShell>
  );
