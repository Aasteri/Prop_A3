...
import { ApiError, getToken, getUser, submitInquiry, type AuthUser } from '@/lib/api';
import type { PublicCompany, PublicListing, PublicStats } from '@/lib/public-server';
import { INPUT_INLINE } from '@/lib/ui';

type HomeClientProps = {
  initialCompany: PublicCompany | null;
  initialFeatured: PublicListing[];
...
export function HomeClient({
  ...
  const [company] = useState<PublicCompany | null>(initialCompany);
  const [featured] = useState<PublicListing[]>(initialFeatured);
  const [stats] = useState<PublicStats | null>(initialStats);
